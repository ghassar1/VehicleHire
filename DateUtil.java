...
public class DateUtil
{
   ...
   static
   {
      ...
      longDatePattern = "EEEE, d MMMM yyyy"; // e.g. Tuesday, 4 October 2011
                                             // EEEE (4 or more) = day in week, in full e.g. Tuesday
                                             // MMMMM (4 or more) = month name as text in full e.g. October
                                             // d = day as 1 or 2 digits e.g. 8th of month -> 8, 23rd -> 23
                                             //
      ...
      dateFormatter.setLenient(false); // default is true and impossible dates such
                                       // as 31-09-2008 would be accepted but interpreted as 01-10-2008
   }

   /**
    * Converts a Date object to a corresponding String in
    * the long date pattern style "Tuesday, 4 January 2013".
    *
   ...
   /**
    * Converts a Date object to a corresponding String in
    * the short date pattern style "04-01-2013".
    *
    * @param     date  a Date object
    *
   ...
   /**
    * Converts a string in the short date pattern style "04-01-2013"
    ...
    * format dd-mm-yyy (e.g. 04-01-2013 or 4-1-2013) where dd represents
